...
public class SwipeRefreshListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private OnSwipeRefreshListener mOnRefreshListener;  //刷新接口
     ...
     */
    public void setOnSwipeRefreshListener(OnSwipeRefreshListener onRefreshListener){
    ...
    private void init(Context context) {
        ...
        //加载头布局
        headView = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.swipe_refresh_headview,this,false);
        //测量头布局
